...
class FFMPEG:
    ...
    def __init__(self, src: str, output_file: str, duration: int,res: Resolution = Resolution.RES_1920x1080,
        ...
        """
        self._base_command += f'-video_size {res} + -c:v {encoding} -i {src} -t {duration} -c:v copy {output_file}'
