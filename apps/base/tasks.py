...
@celery.shared_task
def record_video(pk: int, file_path: str, stop_time, semester_course_id: int) -> None:
    """
    ...
    rpi.record(file_path=file_path, stop_time=stop_time, course_id=semester_course_id)
